...
export default function UserMetaCard({ name, roleLabel, location = "-" }: UserMetaCardProps) {
  ...
  const handleSave = async () => {
    ...
    if (!publicUrlData?.publicUrl) {
      setErrorMessage("Unable to retrieve uploaded avatar url.");
      setIsSaving(false);
      return;
    }
        ...
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
          ...
          <form className="flex flex-col">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <input
                      ...
                      className="mt-2 block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-700 shadow-theme-xs file:mr-3 file:rounded-md file:border-0 file:bg-gray-100 file:px-3 file:py-2 file:text-sm file:font-medium file:text-gray-700 hover:file:bg-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:file:bg-gray-700 dark:file:text-gray-200"
                    />
                    <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                      Choose a new avatar image. The preview updates before saving.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-center gap-3 px-2 mt-6 lg:justify-end">
              ...
              <Button size="sm" variant="default" onClick={handleSave} type="button" disabled={isSaving}>
